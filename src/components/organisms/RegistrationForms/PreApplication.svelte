...
<script>
    ...
    let ableToAttend = ["Yes (General Orientation)", "Yes (Special Orientation)",  "No"];
...
<RegSectionBody>
    ...
    >
        <div id="components">
            ...
            <TextInputComponent label="Name" required={true} placeholder="Dela Cruz, Juan D."/>
            ...
            <NumberInputComponent label="Contact Number" required={true} placeholder="09XXXXXXXXX"/>
            <EmailInputComponent label="Personal Email Address" required={true} placeholder="jdelacruz@gmail.com"/>
            <TextInputComponent label="Facebook Profile Link" required={true} placeholder="https://www.facebook.com/ACSSUPLB"/>
            <RadioInputComponent label="Were you able to attend the organization's Orientation?" options={ableToAttend}/>    
            <!-- END OF CUSTOMIZATION -->
        </div>
