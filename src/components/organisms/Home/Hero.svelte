...
<section class="container mx-auto px-5">
    <div
        class="flex justify-between py-60 flex-1"
    >
        <!-- Hero Caption -->
        ...
        <div class="relative flex-1">
            ...
            <img
                ...
                class="absolute top-[25%] left-[80%] sm:top-[-10%] sm:left-[68%] lg:left-[64%] h-20"
            />
            ...
            <img
                src="/assets/gradient-ellipse.svg"
                alt="Gradient Ellipse"
                class="absolute bottom-[22%] left-[2%] ss:bottom-[14%] ss:left-[28%] lg:bottom-[-10%] lg:left-[34%] h-10"
            />
            ...
            <img
                ...
                class="absolute top-[8%] lg:top-[-40%] left-[10%] sm:left-[12%] lg:left-[10%] xl:left-[20%] h-48 lg:h-60"
            />
