    ...
    "projects" : [
        {
            ...
            developers: [
                {id: 0, name: "Charles Cyrus Chavez", role: "Project Manager", socials: ["/github icon.svg", "/google icon.svg", "/linkedin icon.svg"], links:["","", "https://www.linkedin.com/in/charles-cyrus-chavez-53146013a/"  ],  ts:["","",""], pic:["/dev_charles.webp"]},
                {id: 1, name: "Jericho <br> Calibuso", role: "Lead Developer", socials: ["/github icon.svg", "/google icon.svg", "/linkedin icon.svg"],links:["","","https://www.linkedin.com/in/jerichocalibuso/" ], ts:["","",""], pic:["/devpic_jericho.webp"] },
                ...
                {id: 3, name: "Rene Jotham Culaway", role: "Developer", socials: ["/github icon.svg", "/google icon.svg", "/linkedin icon.svg"], links:["","","https://www.linkedin.com/in/rene-jotham-culaway-64b0961b7/",  ], ts:["","",""],pic:["/dev_jotham.webp"]},
...

        {
            ...
            developers: [
                ...
                {id: 1, name: "Renz <br> Tegrado", role: "Back End Developer", socials: ["/github icon.svg", "/google icon.svg", "/linkedin icon.svg"], links:["", "", ""  ],ts:["/rust.svg","/express.svg","/next.svg"], pic:["/dev_renz.webp"]},
                ...
                {id: 6, name: "Darwin Reigh Calub", role: "Front End Developer", socials: ["/github icon.svg", "/google icon.svg", "/linkedin icon.svg"], links:["https://github.com/Darwinwinner", "mailto:dlcalub1@up.edu.ph", ""  ],ts:["/svelte.svg","/flutter.svg","/react.svg"], pic:["/dev_darwin.webp"]},
                ]
...

        {
            ...
            developers: [
                {id: 0, name: "Jericho <br> Calibuso", role: "Project Manager", socials: ["/github icon.svg", "/google icon.svg", "/linkedin icon.svg"], links:["", "", "https://www.linkedin.com/in/jerichocalibuso/"  ],  ts:["","",""], pic:["/devpic_jericho.webp"]},
                {id: 1, name: "Jezreel Mae Estares", role: "Developer", socials: ["/github icon.svg", "/google icon.svg", "/linkedin icon.svg"], links:["", "", "" ],   ts:["","",""], pic:["/devpic_jezreel.webp"]},
                {id: 2, name: "Ethan <br> Paguila", role: "Developer", socials: ["/github icon.svg", "/google icon.svg", "/linkedin icon.svg"], links:["https://www.linkedin.com/in/EthanPaguila/", "mailto:rtpaguila@up.edu.ph", "https://github.com/ReethP"  ],  ts:["","",""], pic:["/devpic_ethan.webp"]},
                {id: 3, name: "John Karl Tumpalan", role: "Developer", socials: ["/github icon.svg", "/google icon.svg", "/linkedin icon.svg"], links:["", "", ""  ],  ts:["","",""], pic:["/devpic_karl.webp"]},
