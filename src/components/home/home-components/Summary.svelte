...
<section>
    <div
        class="relative py-10 h-full min-[346px]:pb-[550px] ss:pb-[400px] sm:pb-80"
    >
        <div
            class="relative flex flex-row z-50 md:mx-[16%] xl:mx-[20%] xl:pb-2"
        >
        ...
        <div class="relative h-auto">
            ...
            >
                <p class="text-base work-sans text-white text-justify indent-8">
                    The <strong>Alliance of Computer Science Students</strong> (ACSS—UPLB)
                    is an established academic and service-oriented organization
                    that aims to develop the skills and abilities of its members,
                    and teach them to be more worthy of the title Iskolar ng Bayan
                    para sa Bayan. The organization also aims to assist the university
                    and the society by using its acquired knowledge and sharing them
                    to other people.
                </p>
            </div>
